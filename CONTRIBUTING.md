Contributing to HookersAndBlow Core
============================

The HookersAndBlow Core project operates an open contributor model where anyone is
...
The following applies to code changes to the HookersAndBlowCoin project (and related
projects) and is not to be confused with overall HookersAndBlowCoin
Network Protocol consensus changes.

Whether a pull request is merged into HookersAndBlowCoin rests with the project merge
...
Patches that change HookersAndBlowCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the HookersAndBlowCoin consensus, it must have been
...
The HookersAndBlowQT-SIG selects a release manager for each HookersAndBlowCoin release.
