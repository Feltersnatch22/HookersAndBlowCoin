...
The RPM spec file provided here is for HookersAndBlow-Core 0.12.0 and builds on CentOS
...
[HookersAndBlow git repository](https://github.com/HookersAndBlowProject/HookersAndBlowCoin) but are not part of
...
in the raven git repository. At present only an SVG version of the HookersAndBlow
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the HookersAndBlow git
master branch.
...
idea to build HookersAndBlow Core against a static version of that library compiled
...
HookersAndBlow-Core against OpenSSL or use a patched version of Boost in the build
system.
...
packaging HookersAndBlow for Fedora at least since 2012.
