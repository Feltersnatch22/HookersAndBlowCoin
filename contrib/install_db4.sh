...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the HookersAndBlowCoin repository."
  exit 1
fi
...
echo 'When compiling HookersAndBlowCoin, run `./configure` in the following way:'
echo
