...
"""
    ...
    HookersAndBlow should be started with the command line arguments:
...
print("Getting HookersAndBlowCoin msgs")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND HNB issuance at " + str(pos))
				print("After HNB: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND HNB something at " + str(pos))
			start += pos+8
			print(astr)
