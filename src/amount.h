 ...
 *
 * Note that this constant is *not* the total money supply, which in HookersAndBlow
 * currently happens to be less than 21,000,000,000 HNB for various reasons, but
