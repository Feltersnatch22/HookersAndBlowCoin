...
#ifndef HOOKERSANDBLOWCOIN_ASSET_PROTOCOL_H
#define HOOKERSANDBLOWCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_RAVEN_ASSET HNBQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET HNBO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET HNBR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_RAVEN_ASSET HNBT
...
#endif //HOOKERSANDBLOWCOIN_ASSET_PROTOCOL_H
