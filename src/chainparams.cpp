...
{
    const char* pszTimestamp = "HookersAndBlowCoin genesis 18/Jun/2026 fair launch peer-to-peer asset network";
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ASSETS].nStartTime = 1750251600; // HNB mainnet genesis
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MSG_REST_ASSETS].nStartTime = 1755435600; // +60 days
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nStartTime = 1758027600; // +90 days
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nTimeout = 1854843600;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nStartTime = 1758027600; // +90 days
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nTimeout = 1854843600;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nStartTime = 1759237200; // +104 days
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nTimeout = 1854843600;
        ...
        genesis = CreateGenesisBlock(1750251600, 17233052, 0x1e00ffff, 4, 5000 * COIN);

        consensus.hashGenesisBlock = genesis.GetX16RHash();

        assert(consensus.hashGenesisBlock == uint256S("0000005bc2484f740d4c3087211e3aa44d33e7691c9dfdf099b823f735f0be2b"));
        assert(genesis.hashMerkleRoot == uint256S("23fadd3e19079969445a9ebee92805eba3e26ffc54c4275abb826672a439eeee"));
        ...
        // HookersAndBlow BIP44 cointype in mainnet
        nExtCoinType = 1919;
        ...
        // DGW Activation
        nDGWActivationBlock = 180;

        nMaxReorganizationDepth = 60; // 60 at 1 minute block timespan is +/- 60 minutes.
        nMinReorganizationPeers = 4;
        nMinReorganizationAge = 60 * 60 * 12; // 12 hours

        nAssetActivationHeight = 2016;
        nMessagingActivationBlock = 10080;
        nRestrictedActivationBlock = 10080;

        nKAAAWWWPOWActivationTime = 1758027600; // UTC: +90 days from mainnet genesis
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MSG_REST_ASSETS].nOverrideMinerConfirmationWindow = 2016;
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].bit = 8;
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nStartTime = 1758031200; // +90 days
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nTimeout = 1854843600;
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nOverrideRuleChangeActivationThreshold = 1310;
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nOverrideMinerConfirmationWindow = 2016;
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].bit = 9;
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nStartTime = 1758031200; // +90 days
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nTimeout = 1854843600;
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nOverrideRuleChangeActivationThreshold = 1411; // Approx 70% of 2016
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nOverrideMinerConfirmationWindow = 2016;
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].bit = 10;
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nStartTime = 1759240800; // +104 days
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nTimeout = 1854843600;
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nOverrideRuleChangeActivationThreshold = 1411; // Approx 70% of 2016
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nOverrideMinerConfirmationWindow = 2016;
        ...
        uint32_t nGenesisTime = 1750255200;  // HNB testnet genesis

        genesis = CreateGenesisBlock(nGenesisTime, 26670451, 0x1e00ffff, 2, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();

        assert(consensus.hashGenesisBlock == uint256S("0x0000001e7af0fe066e9f6821066e3db8db681137bd192a41bb799a55b4c883d0"));
        assert(genesis.hashMerkleRoot == uint256S("23fadd3e19079969445a9ebee92805eba3e26ffc54c4275abb826672a439eeee"));
        ...
        // HookersAndBlow BIP44 cointype in testnet
        nExtCoinType = 1;
        ...
        nKAAAWWWPOWActivationTime = 1752847200; // UTC: +30 days from testnet genesis
        nKAWPOWActivationTime = nKAAAWWWPOWActivationTime;
        /** HNB End **/
    }
};
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1750258800, 1, 0x207fffff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();

        assert(consensus.hashGenesisBlock == uint256S("0x6c166ef5fd6f6eab6429ce4907aef27c3edf81b764c710b139c65b59adc89152"));
        assert(genesis.hashMerkleRoot == uint256S("0x23fadd3e19079969445a9ebee92805eba3e26ffc54c4275abb826672a439eeee"));
        ...
        // HookersAndBlow BIP44 cointype in regtest
        nExtCoinType = 1;
