...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, HookersAndBlowUnits::SeparatorStyle separators=HookersAndBlowUnits::separatorStandard) const;
