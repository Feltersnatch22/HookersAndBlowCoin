...
/* HookersAndBlowCoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05239")
/* HookersAndBlowCoin light orange */
#define COLOR_LIGHT_ORANGE QColor("#f79433")
/* HookersAndBlowCoin dark blue */
#define COLOR_DARK_BLUE QColor("#384192")
/* HookersAndBlowCoin light blue */
#define COLOR_LIGHT_BLUE QColor("#5874cf")
/* HookersAndBlowCoin asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* HookersAndBlowCoin shadow color - light mode */
...
/* HookersAndBlowCoin shadow color - dark mode */
#define COLOR_SHADOW_DARK QColor("#0c1b3d")
/* HookersAndBlowCoin Light blue - dark mode - dark mode */
#define COLOR_LIGHT_BLUE_DARK QColor("#1e2636")
/* HookersAndBlowCoin Dark blue - dark mode - dark mode */
#define COLOR_DARK_BLUE_DARK QColor("#0b1018")
/* Pricing widget background color */
#define COLOR_PRICING_WIDGET QColor("#161e2d")
/* HookersAndBlowCoin dark mode administrator background color */
#define COLOR_ADMIN_CARD_DARK COLOR_BLACK
/* HookersAndBlowCoin dark mode regular asset background color */
...
/* HookersAndBlowCoin label color as a string */
