...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<HookersAndBlowAmountField*>("payAmount")->setValue(amount);
...
void TestGUI()
{
    ...
    QString balanceComparison = HookersAndBlowUnits::formatWithUnit(unit, balance, false, HookersAndBlowUnits::separatorAlways);
    ...
    // Amount input
    HookersAndBlowAmountField* amountInput = receiveCoinsDialog.findChild<HookersAndBlowAmountField*>("reqAmount");
