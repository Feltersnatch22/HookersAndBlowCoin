...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatHookersAndBlowURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + HookersAndBlowUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatHookersAndBlowURI(info));
}
