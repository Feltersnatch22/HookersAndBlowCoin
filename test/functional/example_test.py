...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HookersAndBlowTestFramework
    pass

class ExampleTest(HookersAndBlowTestFramework):
    # Each functional test is a subclass of the HookersAndBlowTestFramework class.
    ...
    def custom_method(self):
        ...
        HookersAndBlowTestFramework class so other tests can use it."""
