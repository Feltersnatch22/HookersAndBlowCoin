...
class WalletTest(HookersAndBlowTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 HNB from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 HNB with subtract fee from amount
        ...
        # Sendmany 10 HNB with subtract fee from amount
