...
class TxnMallTest(HookersAndBlowTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 HNB:
        ...
        # First: use raw transaction API to send 1240 HNB to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 HNB coin each
        ...
        # Node0's balance should be starting balance, plus 50HNB for another
        ...
        # Node0's total balance should be starting balance, plus 100HNB for 
