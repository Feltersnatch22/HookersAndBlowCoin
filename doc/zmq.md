...
The HookersAndBlow Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in HookersAndBlow Core requires the ZeroMQ API >= 4.0.0
...
using. HookersAndBlowd appends an up-counting sequence number to each
