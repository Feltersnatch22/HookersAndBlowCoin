...
====================
Some notes on how to build HookersAndBlow Core in *nix.
...
As mentioned above, when maintaining portability of the wallet between the standard HookersAndBlow Core distributions and independently built
