...
It is possible to run HookersAndBlow as a Tor hidden service, and connect to such services.
...
The first step is running HookersAndBlow behind a Tor proxy. This will already make all
...
HookersAndBlow Core has been updated to make use of this.

This means that if Tor is running (and proper authentication has been configured),
HookersAndBlow Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if HookersAndBlow Core is listening (`-listen`), and
