# HookersAndBlowCoin - Community Ideas
...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of HookersAndBlowCoin that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like ravend does for HNB)
...
* Run a contest: HNB prize for best idea for new HookersAndBlowCoin based Business
...
* Back-end API platform for HookersAndBlowCoin
    * Other people to hit high-availablity API
* Fee system to pay HNB fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of HNB for fees.
...
* #KYC tagger - store info and tag HookersAndBlowCoin addresses
* #ACCREDITED - verify accredited status and tag HookersAndBlowCoin addresses
 
### Technical Consultant
* Help companies apply HookersAndBlowCoin capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional HNB and asset support


### Areas for HookersAndBlowCoin Innovation
* Financial
